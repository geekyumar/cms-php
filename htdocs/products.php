...
$result = products::list($session_token, $id);
  ...
  <div class="card mb-4 box-shadow">
    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-between align-items-center">
        <div class="btn-group">
        <a href="/edit_product?product_id=<?echo $row['product_id']?>" class="btn btn-link pe-3 ps-0 mb-0 ms-auto w-25 w-md-auto" data-toggle="tooltip" data-original-title="Edit user">
              Edit
            </a>
            <a href="javascript:;" onclick="deleteProduct('<?echo $row['product_id']?>')" class="btn btn-link pe-3 ps-0 mb-0 ms-auto w-25 w-md-auto" data-toggle="tooltip" data-original-title="Edit user">
                          Delete
                        </a>
        </div>
        <small class="text-muted"><?echo $row['product_create_time']?></small>
      </div>
    </div>
  </div>
</div>
...
function deleteProduct(id) {
  ...
  { 
    ...
    request.open('product', '/api/products/deleteproduct.api.php', true)
