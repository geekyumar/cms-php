            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="d-flex justify-content-around bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder pr-10 mt-1 mb-0">Change Password</h4>
                 <p></p>
                </div>
              </div>
              <div class="card-body">
                <form role="form" class="text-start" id="myForm">
                  ...
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <input type="password" id="new-pass" rows="8" class="form-control">
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    <label class="form-label">Re-Enter new password</label>
                    <input type="password" id="re-new-pass" rows="8" class="form-control">
                  </div>

                  <div class="text-center">
                    <button type="button" onclick="changePass()" class="btn bg-gradient-primary w-100 my-4 mb-2">Change Password</button>
</div>
                </form>
              </div>
            </div>
...
function changePass() { 
    ...
    var re_new_pass = document.getElementById('re-new-pass').value

    var request = new XMLHttpRequest();
    request.open('POST', '/api/changepassword.api.php', true)
    ...
    request.onload = function()
    {
      if(request.status === 200)
      {
        ...
        if(responseData['response'] == 'success')
        {
          ...
          alert("Non-matching credentials, Change Password Failed!")
        } 
      }
      else{
